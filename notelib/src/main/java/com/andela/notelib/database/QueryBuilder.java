...
public class QueryBuilder {
    ...
    public QueryBuilder addColumn(String columnName, String TYPE, boolean primaryKey) {
        appendColumn(columnName, TYPE);
        query.append(primaryKey && TYPE.equals(INTEGER) ? " primary key autoincrement " : " primary key ");
        query.append(" , ");
        return this;
    }
    ...
    public QueryBuilder orderBy(String field, String value) {
        appendQuery(" ORDER BY " + field + " " + value + " ");
        return this;
    }
